...
(def gShortChains (transitive-closure (add-loops (lg/digraph
                                                   [0 1]
                                                   [1 2]
                                                   [2 3]
                                                   [0 4]
...
(def gThreeLongChains (transitive-closure (add-loops (lg/digraph
                                                       [0 1]
                                                       [1 2]
                                                       [2 3]
                                                       [3 4]
...
(deftest test-sat-reduction
  (is (let [red (sat-reduction (lg/graph [:a :b] [:a :c] [:b :e] [:c :e] [:a :e]) 1)]
        (or (= red '(:a))
            (= red '(:e)))))
